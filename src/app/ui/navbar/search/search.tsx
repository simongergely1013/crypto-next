...
const styles = {
    ...
    searchDropdown: 'absolute top-14 z-10 w-[356px] bg-[#1F1934] text-sm text-white pl-4 py-2 border-l border-r border-b rounded-b border-slate-700'
}
    ...
    return(
        ...
        <div className={styles.main}>
            ...
            {value !== '' && <div className={styles.searchDropdown}>
                {searchList.map(el => <p className="mb-1">{el.name}</p>)}
                </div>}
            </div>
            </>
    )
